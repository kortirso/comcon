...
### Fixed
- bug with guild invites to events for not main characters

## [1.3.4] - 2020-05-02
### Modified
- for line up show only approved characters in counter
- hide bank coins for simple users
...
## [1.3.3] - 2020-04-12
### Fixed
- using webp images for bad browsers
...
### Fixed
- bug with sorting of alternative renderer
