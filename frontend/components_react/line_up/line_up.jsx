...
export default class LineUp extends React.Component {
  ...
  _renderAdminButton(subscribe, size) {
    return <button className={`btn btn-icon btn-edit ${size}`} onClick={() => this._showApprovingBox(subscribe, true)}></button>
  }

  _renderUserButton(subscribe) {
    return <button className="btn btn-icon btn-edit" onClick={() => this._showApprovingBox(subscribe, false)}></button>
  }
