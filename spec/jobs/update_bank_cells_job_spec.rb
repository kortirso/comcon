RSpec.describe UpdateBankCellsJob, type: :job do
  ...
  it 'executes UpdateBankCellsService' do
    expect_any_instance_of(UpdateBankCellsService).to receive(:call).and_call_original

    described_class.perform_now(bank_id: bank.id, cells_info: cells_info)
  end
end
