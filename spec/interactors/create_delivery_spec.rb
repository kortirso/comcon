describe CreateDelivery do
  ...
  describe '.call' do
    context 'for existed delivery' do
      ...
      let(:interactor) { CreateDelivery.call(delivery_params: { deliveriable_id: guild.id, deliveriable_type: 'Guild', notification: notification }) }
  ...
  describe '.rollback' do
    subject(:interactor) { CreateDelivery.new(delivery_params: { deliveriable_id: guild.id, deliveriable_type: 'Guild', notification: notification }) }
