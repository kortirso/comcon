describe CreateDeliveryParam do
  ...
  describe '.call' do
    context 'for existed delivery param' do
      ...
      let(:interactor) { CreateDeliveryParam.call(delivery_param_params: { 'params' => { 'id' => 123, 'token' => '123' } }, delivery: delivery) }
      ...
      it 'and does not create delivery' do
        expect { interactor }.to_not change(DeliveryParam, :count)
      end
    end
