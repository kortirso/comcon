describe CreateCharacterProfessions do
  ...
  describe '.call' do
    context 'for unexisted character profession' do
      let(:interactor) { CreateCharacterProfessions.call(character_id: character.id, profession_params: { profession.id.to_s => '1' }) }
    ...
    context 'for existed character profession' do
      ...
      let(:interactor) { CreateCharacterProfessions.call(character_id: character.id, profession_params: { profession.id.to_s => '0' }) }
